...
(custom-set-variables
 ...
 '(package-selected-packages
   '(auctex ansible clipetty coverlay coverage doom-modeline use-package flatbuffers-mode lsp-sonarlint cov git-lens lsp-java pbcopy robe projectile which-key company-prescient yasnippet-snippets modern-cpp-font-lock yasnippet lsp-mode lsp-treemacs lsp-ui zenburn-theme ccls magit-todos magit clang-format hl-todo pyvenv ws-butler docbook))
